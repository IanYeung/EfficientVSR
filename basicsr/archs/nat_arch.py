...
from basicsr.archs.arch_util import trunc_normal_, DropPath, to_2tuple
from basicsr.ops.nat.natten import NeighborhoodAttention
...
if __name__ == '__main__':
    ...
    net = NAT(depths=[3, 4, 6, 5], num_heads=[2, 4, 8, 16], embed_dim=64,
              mlp_ratio=3, drop_path_rate=0.2, kernel_size=7).to(device)

    out = net(inp)
    print(out.shape)

    nat_layer = NATLayer(kernel_size=3)