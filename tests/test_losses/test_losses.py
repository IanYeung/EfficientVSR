...
from basicsr.losses.losses import CharbonnierLoss, L1Loss, MSELoss, WeightedTVLoss, BestBuddyLoss
...
if __name__ == '__main__':
    bb_loss = BestBuddyLoss()
    sr = torch.randn(1, 3, 192, 192)
    gt = torch.randn(1, 3, 192, 192)
    loss = bb_loss(sr, gt)
